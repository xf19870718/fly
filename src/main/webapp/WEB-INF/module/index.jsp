...
<head>
    ...
    <link href="<%=basePath%>static/util/js/ligerUI/lib/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet"
          type="text/css"/>
    <link rel="stylesheet" type="text/css" id="mylink"/>
    <script src="<%=basePath%>static/util/js/ligerUI/lib/jquery/jquery-1.3.2.min.js" type="text/javascript"></script>
    <script src="<%=basePath%>static/util/js/ligerUI/lib/ligerUI/js/ligerui.all.js" type="text/javascript"></script>
    <script src="<%=basePath%>static/util/js/ligerUI/lib/ligerUI/js/plugins/ligerTab.js"></script>
    <script src="<%=basePath%>static/util/js/ligerUI/lib/jquery.cookie.js"></script>
    <script src="<%=basePath%>static/util/js/ligerUI/lib/json2.js"></script>
    <script src="<%=basePath%>static/util/js/ligerUI/indexdata.js" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        var skin_links = {
            "aqua": "<%=basePath%>static/util/js/ligerUI/lib/ligerUI/skins/Aqua/css/ligerui-all.css",
            "gray": "<%=basePath%>static/util/js/ligerUI/lib/ligerUI/skins/Gray/css/all.css",
            "silvery": "<%=basePath%>static/util/js/ligerUI/lib/ligerUI/skins/Silvery/css/style.css",
            "gray2014": "<%=basePath%>static/util/js/ligerUI/lib/ligerUI/skins/gray2014/css/all.css"
        };
        function pages_init() {
    ...
    <style type="text/css">
        ...
        .l-topmenu {
            ...
            height: 31px;
            line-height: 31px;
            background: url('<%=basePath%>static/util/js/ligerUI/lib/images/top.jpg') repeat-x bottom;
            position: relative;
        ...
        .l-topmenu-logo {
            ...
            padding-left: 35px;
            line-height: 26px;
            background: url('<%=basePath%>static/util/js/ligerUI/lib/images/topicon.gif') no-repeat 10px 5px;
        }
...
<div id="layout1" style="width:99.2%; margin:0 auto; margin-top:4px; ">
    ...
    <div position="center" id="framecenter">
        <div tabid="home" title="我的主页" style="height:300px">
            <iframe frameborder="0" name="home" id="home" src="<%=basePath%>static/module/welcome.htm"></iframe>
        </div>
    </div>
